package at.chaotistin.dragonquestcraft.goals;
...
public class CustomBreedGoal extends Goal {
    ...
    public CustomBreedGoal(AnimalEntity animal, double speedIn) {
        this(animal, speedIn, animal.getClass());
    }

    public CustomBreedGoal(AnimalEntity p_i47306_1_, double p_i47306_2_, Class<? extends AnimalEntity> p_i47306_4_) {
    ...
    private AnimalEntity getNearbyMate() {
        List<AnimalEntity> list = this.world.getTargettableEntitiesWithinAABB(AnimalEntity.class, field_220689_d, this.animal, this.animal.getBoundingBox().grow(8.0D));
