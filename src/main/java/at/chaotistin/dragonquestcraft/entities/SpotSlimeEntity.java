...
public class SpotSlimeEntity extends CustomTameableEntity implements IMob {
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.createKey(SpotSlimeEntity.class, DataSerializers.FLOAT);

    public SpotSlimeEntity(EntityType<? extends SpotSlimeEntity> type, World worldIn) {
        super(type, worldIn);
        this.setTamed(false);
