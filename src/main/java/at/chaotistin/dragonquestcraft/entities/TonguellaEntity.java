...
public class TonguellaEntity extends CustomTameableEntity {

    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.createKey(TonguellaEntity.class, DataSerializers.FLOAT);

    public TonguellaEntity(EntityType<? extends TonguellaEntity> type, World worldIn) {
        super(type, worldIn);
        this.setTamed(false);
